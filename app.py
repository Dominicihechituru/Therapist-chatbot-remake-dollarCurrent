...
def rex():
    ...
    if request.method == 'POST':
        ...
        if prompt_count >= 2 and not check_subscription_status(subscription_code):
            return jsonify({'answer': "NOTIFICATION!!!: Sorry, it looks like you've hit your free message limit or your subscription has expired. <a href='{{ url_for('payment') }}'>Click here to continue with a weekly or monthly plan</a"}), 200
