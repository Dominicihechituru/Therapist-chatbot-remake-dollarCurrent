...
def rex():
    ...
    if request.method == 'POST':
        ...
        if prompt_count >= 2 and (check_subscription_status(subscription_code) != "active" and check_subscription_status(subscription_code) != "completed" and check_subscription_status(subscription_code) != "expired" and check_subscription_status(subscription_code) != "contactsupport"):
